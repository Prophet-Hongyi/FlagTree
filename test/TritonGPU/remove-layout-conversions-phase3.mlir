...
// TRACE-DAG: FLAGTREE_RLC_TRACE phase=policy outcome=accept reason=context-ready{{.*}}online_launch_count=1
// TRACE-DAG: FLAGTREE_RLC_TRACE phase=3 outcome=accept reason=writeback-rematerialized op=tt.atomic_rmw{{.*}}online_launch_count=1{{.*}}online_removed_converts=1{{.*}}online_saved_cost={{[1-9][0-9]*}}{{.*}}online_adjusted_saved_cost_per_tensor_op={{[1-9][0-9]*}}{{.*}}online_atomic_ops=1
...
module attributes {"ttg.num-ctas" = 1 : i32, "ttg.num-warps" = 4 : i32, "ttg.rlc-product-launch-count" = 1 : i32, "ttg.rlc-profitability-max-external-use-edges" = 0 : i64, "ttg.rlc-profitability-min-adjusted-saved-cost-per-tensor-op" = 1 : i64, "ttg.rlc-profitability-phase3-saved-cost-multiplier" = 2 : i64, "ttg.rlc-profitability-policy-enabled" = 1 : i32, ttg.target = "cuda:90", "ttg.threads-per-warp" = 32 : i32} {
