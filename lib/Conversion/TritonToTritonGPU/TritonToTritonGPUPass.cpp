...
#ifdef __TLE__
class TleEncodingOpPattern : public OpConversionPattern<tle::EncodingOp> {
public:
  using OpConversionPattern::OpConversionPattern;

  LogicalResult
  matchAndRewrite(tle::EncodingOp op, tle::EncodingOp::Adaptor adaptor,
                  ConversionPatternRewriter &rewriter) const override {
