...
def _dot_encoding_frontend_kernel(
    ...
    lhs = tle.encoding(tl.zeros((32, 32), tl.bfloat16), lhs_layout)
    rhs = tle.encoding(tl.zeros((32, 8), tl.bfloat16), rhs_layout)
    acc = tle.encoding(tl.zeros((32, 8), tl.float32), mma_layout)
